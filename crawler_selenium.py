...
attachment_xpath_5 = '/html/body/center/p[1]/table[2]/tbody/tr[4]/td[2]/table/tbody/tr[2]/td/p[2]/font/font/font/a[2]'
attachment_xpath_list = [attachment_xpath_1, attachment_xpath_2, attachment_xpath_3, attachment_xpath_4, attachment_xpath_5]
page_number = 1
filter_list = ['vipArea', 'sexyhub', 'muse', 'digitalplayground', 'vintageFlash', 'wicked', 'photodromm', 'naughtyAmerica', 'brazzers', '刪除', 'mc-nudes', 'hollyRandall', 'penthouse', 'only-opaques', 'onlysilkandsatin', 'only-secretaries', 'onlytease']
end_date = '2016-11-19'
...
def main():
    ...
    for i in range(1, 10):  # loop to which page
        ...
        if i == 1:
            ...
            xpath_list_2 = []
            for row in range(3, 43):  # threads number in one page 3, 43
                xpath_list_item = '/html/body/center/table[7]/tbody/tr[' + str(row) + ']/td[2]/a'
